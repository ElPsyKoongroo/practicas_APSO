...
void permisos(struct stat *datos_fichero) {
    if (datos_fichero->st_mode & S_IRUSR)
        printf("r");
    else
        printf("-");

    if (datos_fichero->st_mode & S_IWUSR)
        printf("w");
    else
        printf("-");

    if (datos_fichero->st_mode & S_IXUSR)
        printf("x");
    else
        printf("-");

    // GROUP
    if (datos_fichero->st_mode & S_IRGRP)
        printf("r");
    else
        printf("-");

    if (datos_fichero->st_mode & S_IWGRP)
        printf("w");
    else
        printf("-");

    if (datos_fichero->st_mode & S_IXGRP)
        printf("x");
    else
        printf("-");

    // OTHERS
    if (datos_fichero->st_mode & S_IROTH)
        printf("r");
    else
        printf("-");

    if (datos_fichero->st_mode & S_IWOTH)
        printf("w");
    else
        printf("-");

    if (datos_fichero->st_mode & S_IXOTH)
        printf("x");
    else
        printf("-");
