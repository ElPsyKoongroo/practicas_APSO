...
main()
{
	...
	Mensaje_p2.Dato_Numerico = 13;
	Mensaje_p2.Decimal=13.1322658;
	...
	printf("COLA2: Recibido mensaje tipo 1\n");
	printf("COLA2: Dato_Numerico = %d\n",Mensaje_p1.Dato_Numerico);
	printf("COLA2: Mensaje = %s\n",Mensaje_p1.Mensaje);
